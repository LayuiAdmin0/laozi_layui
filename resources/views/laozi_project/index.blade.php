    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="{{url('/laozi/info')}}">基本资料</a></dd>
              <dd><a lay-href="{{url('/laozi/password')}}">修改密码</a></dd>
              <hr>
              <dd style="text-align: center;"><a href="{{url('/laozi/loginOut')}}">退出</a></dd>
            </dl>
          </li>
        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                <dd data-name="console" class="layui-this">
                  <a lay-href="/laozi/console">控制台</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="/laozi/homepage1">主页1</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="/laozi/homepage2">主页二</a>
                </dd>
              </dl>
            </li>
            ...
            <li data-name="template" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd><a lay-href="{{url('/laozi/personalpage')}}">个人主页</a></dd>
                <dd><a lay-href="{{url('/laozi/addresslist')}}">通讯录</a></dd>
                ...
                <dd><a href="{{url('/laozi/login')}}" target="_blank">登入</a></dd>
            ...
            <li data-name="set" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                <dd class="layui-nav-itemed">
                  ...
                  <dl class="layui-nav-child">
                    <dd><a lay-href="{{url('/laozi/info')}}">基12本资料</a></dd>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="{{url('/laozi/console')}}" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
