...
<head>
  ...
  <link rel="stylesheet" href="/laozi_project/layuiadmin/layui/css/layui.css" media="all">
  <link rel="stylesheet" href="/laozi_project/layuiadmin/style/admin.css" media="all">
  <link rel="stylesheet" href="/laozi_project/layuiadmin/style/template.css" media="all">
</head>
<body>
...
<div class="layui-fluid layadmin-homepage-fluid">
        ...
        <div class="layui-card text-center">
          <div class="layui-card-body">
            <div class="layadmin-homepage-pad-ver">
              <img class="layadmin-homepage-pad-img" src="/laozi_project/layuiadmin/style/res/template/portrait.png" width="96" height="96">
            </div>
            ...
            <div class="grid-demo">
              <div class="panel-body layadmin-homepage-shadow">
                <a href="javascript:;" class="media-left">
                  <img src="/laozi_project/layuiadmin/style/res/template/portrait.png" height="46px" width="46px">
                </a>
                <div class="media-body">
                  ...
                  <img class="h-img" src="/laozi_project/layuiadmin/style/res/template/huge.jpg">
                  <div class="media">
                    ...
                    <div class="media-left">
                      <ul class="list-inline">
                        <li>
                          <a href="javascript:;">
                            <img class="img-xs" src="/laozi_project/layuiadmin/style/res/template/portrait.png">
                          </a>
                        </li>
                        <li>
                          <a href="javascript:;">
                ...
                <div class="layui-card-body">
                  <div class="layui-row layui-col-space15">
                    <div class="layui-col-md4">
                      <img src="/laozi_project/layuiadmin/style/res/template/portrait.png">
                    </div>
                    <div class="layui-col-md4">
                      <img src="/laozi_project/layuiadmin/style/res/template/portrait.png">
                    </div>
  ...
  <script src="/laozi_project/layuiadmin/layui/layui.js"></script>
  <script>
  layui.config({
    base: '/laozi_project/layuiadmin/' //静态资源所在路径
  }).extend({
